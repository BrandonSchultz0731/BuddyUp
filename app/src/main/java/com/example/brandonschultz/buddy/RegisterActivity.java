...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void SendUserToCourseActivity() {
        Intent courseIntent = new Intent(RegisterActivity.this,CourseActivity.class);
        courseIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
